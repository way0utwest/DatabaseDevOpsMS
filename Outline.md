...
* Including your database in development practices – version control, automated builds & testing
* Release management and the database
* Monitoring databases after releases
* Optional - advanced topics such as provisioning for dev and test, branching & merging etc.
